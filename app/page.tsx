    ...
    <div className="arena-container">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed px-4">
          ...
          {/* Retro status bar */}
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 text-xs px-4" style={{fontFamily: '"Press Start 2P", cursive'}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto px-4">
          <div className="fighter-card text-center p-4 sm:p-6 md:p-8 group hover:scale-105 transition-transform">
